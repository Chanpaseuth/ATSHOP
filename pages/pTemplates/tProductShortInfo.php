<div class="col-md-6 top_grid1-box1">
    <div class="grid_1 text-center">
        <a href="index.php?c=3&id=<?= $MaSanPham; ?>">
            <div class="b-link-stroke b-animate-go  thickbox " style="display:flex;justify-content:center">
            <img src="images/sanpham/<?php echo $HinhURL; ?>" class="img-responsive" alt="" width="150px"/> </div>
            <div class="grid_2">
        ...
        <ul class="grid_2-bottom">
            <a href="index.php?c=3&id=<?= $MaSanPham; ?>">
                <li class="grid_2-left">                
                    Giá: <?php echo number_format($Gia,0,",","."); ?>vnđ</p>
                </li>
            </a>
